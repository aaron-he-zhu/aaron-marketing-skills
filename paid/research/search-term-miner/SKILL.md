...
- **Writes**: a user-facing mining diff and reusable summary to `memory/paid-ads/search-term-miner/`.
...
On user confirmation, save to `memory/paid-ads/search-term-miner/YYYY-MM-DD-<account-or-goal>-mining.md` — see [Skill Contract](../../../references/skill-contract.md) §Save Results Template.
