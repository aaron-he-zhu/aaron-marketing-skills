...
| Model-visible explicit aggregate: Skill + shared contract, all 120 | 3,467,372 B | 1,480,865 B with capsule + kernel | −57.3% |
| Model-visible explicit median | 29,383.5 B | 12,331.5 B (~12,332 B) with capsule + kernel | −58.0% |
| All-selected fixed representation aggregate: Skill + controller-only machine contract + shared contract, all 120 | 5,453,076 B | 1,480,865 B with capsule + kernel | −72.8% |
