...
| Index push — tell Bing/DuckDuckGo/Yandex (IndexNow) and Baidu your URLs changed | `indexpush.py indexnow <urls…> --key …` · `indexpush.py baidu … --site … --key …` (dry-run by default, `--live` to submit) | self-minted key / site token |
