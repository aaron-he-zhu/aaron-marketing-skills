...
- Sibling skills in the influencer-marketing family:
  - [content-amplifier](../../activate/content-amplifier/SKILL.md) — source creator content for landing pages.
  - [content-amplifier](../../activate/content-amplifier/SKILL.md) — drive traffic to landing pages.
...
- [content-amplifier](../../activate/content-amplifier/SKILL.md) — when an optimized page is ready and you want to scale traffic to it.
