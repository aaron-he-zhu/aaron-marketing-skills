...
|-------|----------|---------|--------------|
| narrative-baseline-mapper | trace | 20.0.0 | 2026-08-20 |
| category-narrative-mapper | trace | 20.0.0 | 2026-08-20 |
| audience-belief-mapper | trace | 20.0.0 | 2026-08-20 |
| positioning-truth-tracer | trace | 20.0.0 | 2026-08-20 |
| strategic-narrative-designer | architect | 20.0.0 | 2026-08-20 |
| message-system-architect | architect | 20.0.0 | 2026-08-20 |
| brand-language-codifier | architect | 20.0.0 | 2026-08-20 |
| story-bank-builder | architect | 20.0.0 | 2026-08-20 |
| narrative-cascade-planner | land | 20.0.0 | 2026-08-20 |
| pitch-narrative-builder | land | 20.0.0 | 2026-08-20 |
| narrative-enablement-kit | land | 20.0.0 | 2026-08-20 |
| proof-point-packager | land | 20.0.0 | 2026-08-20 |
| narrative-quality-auditor | evaluate | 20.0.0 | 2026-08-20 |
| message-test-designer | evaluate | 20.0.0 | 2026-08-20 |
| narrative-resonance-monitor | evaluate | 20.0.0 | 2026-08-20 |
| narrative-drift-monitor | evaluate | 20.0.0 | 2026-08-20 |
| keyword-research | survey | 20.0.0 | 2026-08-20 |
| competitor-analysis | survey | 20.0.0 | 2026-08-20 |
| serp-analysis | survey | 20.0.0 | 2026-08-20 |
| content-gap-analysis | survey | 20.0.0 | 2026-08-20 |
| content-writer | implement | 20.0.0 | 2026-08-20 |
| geo-content-optimizer | implement | 20.0.0 | 2026-08-20 |
| serp-markup-builder | implement | 20.0.0 | 2026-08-20 |
| page-play-builder | implement | 20.0.0 | 2026-08-20 |
| content-quality-auditor | tune | 20.0.0 | 2026-08-20 |
| technical-seo-checker | tune | 20.0.0 | 2026-08-20 |
| on-page-seo-checker | tune | 20.0.0 | 2026-08-20 |
| site-structure-optimizer | tune | 20.0.0 | 2026-08-20 |
| domain-authority-auditor | evaluate | 20.0.0 | 2026-08-20 |
| rank-tracker | evaluate | 20.0.0 | 2026-08-20 |
| performance-monitor | evaluate | 20.0.0 | 2026-08-20 |
| offsite-signal-analyzer | evaluate | 20.0.0 | 2026-08-20 |
| channel-portfolio-planner | explore | 20.0.0 | 2026-08-20 |
| voice-dossier-builder | explore | 20.0.0 | 2026-08-20 |
| platform-norm-profiler | explore | 20.0.0 | 2026-08-20 |
| participation-warmup-planner | explore | 20.0.0 | 2026-08-20 |
| social-calendar-builder | craft | 20.0.0 | 2026-08-20 |
| social-creative-builder | craft | 20.0.0 | 2026-08-20 |
| short-video-scripter | craft | 20.0.0 | 2026-08-20 |
| advocacy-program-designer | craft | 20.0.0 | 2026-08-20 |
| social-quality-auditor | host | 20.0.0 | 2026-08-20 |
...
| list-segment-builder | email | 20.0.0 | 2026-08-20 |
| list-growth-designer | email | 20.0.0 | 2026-08-20 |
| list-hygiene-monitor | email | 20.0.0 | 2026-08-20 |
| email-creative-builder | email | 20.0.0 | 2026-08-20 |
| subject-line-lab | email | 20.0.0 | 2026-08-20 |
| email-render-builder | email | 20.0.0 | 2026-08-20 |
| dynamic-content-personalizer | email | 20.0.0 | 2026-08-20 |
| email-sequence-designer | email | 20.0.0 | 2026-08-20 |
| newsletter-monetization-planner | email | 20.0.0 | 2026-08-20 |
| preference-frequency-manager | email | 20.0.0 | 2026-08-20 |
| reactivation-specialist | email | 20.0.0 | 2026-08-20 |
| email-quality-auditor | email | 20.0.0 | 2026-08-20 |
| send-experiment-designer | email | 20.0.0 | 2026-08-20 |
| inbox-placement-monitor | email | 20.0.0 | 2026-08-20 |
| cold-outbound-sequencer | email | 20.0.0 | 2026-08-20 |
| campaign-architect | paid | 20.0.0 | 2026-08-20 |
| audience-segment-builder | paid | 20.0.0 | 2026-08-20 |
| search-term-miner | paid | 20.0.0 | 2026-08-20 |
| product-feed-optimizer | paid | 20.0.0 | 2026-08-20 |
| ad-creative-builder | paid | 20.0.0 | 2026-08-20 |
| ad-test-designer | paid | 20.0.0 | 2026-08-20 |
| bid-strategy-planner | paid | 20.0.0 | 2026-08-20 |
| landing-experience-checker | paid | 20.0.0 | 2026-08-20 |
| ad-account-auditor | paid | 20.0.0 | 2026-08-20 |
| conversion-signal-qa | paid | 20.0.0 | 2026-08-20 |
| placement-exclusion-manager | paid | 20.0.0 | 2026-08-20 |
| conversion-value-mapper | paid | 20.0.0 | 2026-08-20 |
| paid-measurement-loop | paid | 20.0.0 | 2026-08-20 |
| attribution-reconciler | paid | 20.0.0 | 2026-08-20 |
...
| outreach-manager | activate | 20.0.0 | 2026-08-20 |
| creator-content-auditor | activate | 20.0.0 | 2026-08-20 |
| contract-helper | activate | 20.0.0 | 2026-08-20 |
| content-amplifier | activate | 20.0.0 | 2026-08-20 |
| landing-optimizer | report | 20.0.0 | 2026-08-20 |
| performance-analyzer | report | 20.0.0 | 2026-08-20 |
| roi-calculator | report | 20.0.0 | 2026-08-20 |
| report-generator | report | 20.0.0 | 2026-08-20 |
| positioning-mapper | launch | 20.0.0 | 2026-08-20 |
| launch-tier-planner | launch | 20.0.0 | 2026-08-20 |
| launch-window-planner | launch | 20.0.0 | 2026-08-20 |
| early-access-designer | launch | 20.0.0 | 2026-08-20 |
| message-house-builder | launch | 20.0.0 | 2026-08-20 |
| launch-asset-packager | launch | 20.0.0 | 2026-08-20 |
| pricing-packaging-planner | launch | 20.0.0 | 2026-08-20 |
| sales-enablement-kit | launch | 20.0.0 | 2026-08-20 |
| launch-readiness-auditor | launch | 20.0.0 | 2026-08-20 |
| launch-day-conductor | launch | 20.0.0 | 2026-08-20 |
| community-launch-runner | launch | 20.0.0 | 2026-08-20 |
| press-media-relations | launch | 20.0.0 | 2026-08-20 |
| launch-monitor | launch | 20.0.0 | 2026-08-20 |
| launch-feedback-synthesizer | launch | 20.0.0 | 2026-08-20 |
| launch-retro-analyzer | launch | 20.0.0 | 2026-08-20 |
| momentum-planner | launch | 20.0.0 | 2026-08-20 |
| entity-registry | protocol | 20.0.0 | 2026-08-20 |
| creator-registry | protocol | 20.0.0 | 2026-08-20 |
| offer-claims-registry | protocol | 20.0.0 | 2026-08-20 |
| consent-registry | protocol | 20.0.0 | 2026-08-20 |
| launch-registry | protocol | 20.0.0 | 2026-08-20 |
| channel-registry | protocol | 20.0.0 | 2026-08-20 |
| narrative-registry | protocol | 20.0.0 | 2026-08-20 |
...
All 120 canonical skills align to `20.0.0` together while the exact 7 ×
...
- **AI Staff install surface.** The named-bot roster (xAI's Grok Bot, Hermes
  Agent's Bot Mode) is presented as a first-class install form alongside the
  plugin and portable skills: seven discipline specialists plus a routing
  chief, generated from the same typed catalog and covering the 120 skills
  exactly once. README gains an "AI Staff" section, an install-table row, and
  a worked @mention handoff example.
- **Vendor-neutral positioning.** The README headline and intro no longer lead
  with a single host. The bundle presents as an installable AI marketing
  staff — one plugin with commands and memory, portable skills on 70+ agent
  hosts, or an 8-bot AI Staff on named-bot hosts.
- **`aaron-chief` handle.** The chief bot's public handle shortens from
  `aaron-chief-of-staff` to `aaron-chief` across the roster generator, its
  Hermes bundle directory (`hermes/chief/`), tests, and deployment docs. The
  display title remains "Chief of Staff"; internal `kind` labels and role
  semantics are unchanged.
- **Boundaries restated, not weakened.** Staff bundles remain Tier-1 static:
  no connectors, `mcp.json`, cron, hooks, or deterministic runtimes; auditors
  return `NOT_SCORED`; registry and durable-memory writes stay propose-only;
  Grok Bot's shared cloud computer caveat is documented in the README section
  itself.


### v19.2.0 — Agent Plugins v1 Portable Lite (2026-08-09)

All 120 canonical skills align to `19.2.0` together while the exact 7 ×
(4 phases × 4 skills) shape, TALE/SITE/ECHO/SEND/ROAS/STAR/RAMP acronym
symmetry, eight public commands, framework/veto IDs, registry keys, and user
state paths remain unchanged.
...
skills align to `19.0.0` together while the exact 7 × (4 phases × 4 skills)
...
Breaking rename release; 120 skills and 8 commands remain unchanged in count. The seven disciplines now share one machine-enforced symmetry contract; deliberate asymmetries live in a typed licensed-deviations ledger instead of scattered prose.

**Migration map (breaking renames):**
...
| seo-geo command | `--mode research\|create\|audit\|track` | `--phase survey\|implement\|tune\|evaluate` (research→survey, create→implement, audit→tune with `--authority` in evaluate, track→evaluate; every sub-flag unchanged; the `--mode` alias is not carried forward) |
...
- **Conform-or-declared enforcement.** `check-architecture.py check_symmetry()` fails any rule violation without a licensed deviation AND any stale deviation that no longer licenses a live violation. Two deviations ship: the two human-view paths that would orphan end-user state.
...
- **Typed gate sinks.** `memory/audits/` is reserved for the eight framework owners. Path-triggered Artifact Gate validation rejects unknown prose/fields, wrong framework/profile/sink combinations, inconsistent veto counts or status/verdict pairs, and aggregate `MULTI` scores.
- **Durable state model.** Seven sole-writer registries now use append-only hash-chained events, idempotency, optimistic revisions, operation-specific payloads, executable state transitions, terminal-record protection, atomic projections, and semantic replay validation; consent suppression/erasure remains immediate and replay-safe.
- **Explicit layer contracts.** Core builders record Narrative canon ID/version, claims projection offset, and dependency status; ordinary producers propose events rather than mutating canonical state.
- **Executable assurance.** Deterministic suites cover scoring, registries, HTTP/connectors, artifact validation, hooks, eval/routing structure, architecture, generated standalone auditor runtimes, generated system docs, and local links; an optional fail-closed semantic adapter supports host/model evaluation.
- **Distribution convergence.** Typed system topology drives canonical ordering across plugin, marketplace, skills.sh, root/localized documentation, and generated architecture docs. Standalone auditors carry immutable hashed runtime bundles and never fetch mutable `main` contracts.
...
Major release per the discipline-addition convention: the bundle grows 103 → **120 skills** (16 × 7 disciplines + 8 protocol), 7 → **8 commands**, 7 → **8 frameworks/gates**, and every skill aligns to `16.0.0`. New discipline `narrative/{trace,architect,land,evaluate}/` on the TALE loop; the eighth registry `narrative-registry` (brand canon SSOT, append-only versioned-canon promotion, seeds `entity-optimizer`, judged by TALE-A1); the eighth framework TALE (`references/tale-benchmark.md`) and gate `narrative-quality-auditor` (NQS + T1/A1/L1/E1); the eighth command `/aaron-marketing:narrative`. **Reuse, not rebuild**: `positioning-mapper`, `message-house-builder`, `audience-mapper`, and the social `share-of-voice-tracker` are reused cross-discipline; **no new connector** ships. This release re-narrates the bundle as a four-layer **Marketing Operating System** (Strategy · Channels · Orchestration · Protocol) — Narrative is the strategy layer every channel expresses — and brings the localized README set (9 languages) to full version-lock.
...
- **CONNECTORS.md official-docs pass** (same release, follow-up commit): every product row now links its **official documentation** (all links HTTP-checked); two new capability rows — **GSC URL Inspection API** (`searchconsole.googleapis.com/v1` — per-URL index status, 2,000/day per property) and **CrUX History API** (40 weekly field-CWV points — a ready-made `ledger.py` baseline series); corrections from re-verification: SISTRIX MCP is now **OAuth, no API key** (2026 rollout), GDELT throttles via plain-text notice *or* 429, CrUX History updates Mondays (align ledger comparisons to weekday).
- **Process hardening** (same release, follow-up commit): `scripts/check-versions.sh` — a CI **version-sync guard** over the 8-file tracking contract (bundle version across plugin.json / marketplace mirrors / README badges / CLAUDE.md / VERSIONS.md release line + changelog, and every SKILL.md ↔ VERSIONS.md row); [docs/connector-playbook.md](docs/connector-playbook.md) — the connector-integration pipeline distilled from the four waves (qualify / verify / implement / test / wire / document / track / regress / record, with the safety-class gate table and connector-vs-recipe rule); `scripts/connectors/smoke-live.sh` — a manual pre-release live smoke (its first run caught GDELT's second throttle shape: a real HTTP 429 alongside the plain-text-on-200 notice — `gdelt.py` now maps both to `rate_limited`); SECURITY.md gains the three-row safety-class table.
...
Structural + hygiene minor release. Every discipline lives under a single top-level folder — `seo-geo/{research,build,optimize,monitor}`, `influencer/{discover,plan,activate,measure}`, `ad/{research,orchestrate,activate,scale}`, `email/{setup,engage,nurture,deliver}`, `protocol/` — completing the 4×4 symmetry (top-level dirs **11 → 5**; eliminates the `activate/` vs `ad/activate/` collision). No skill content or count change (still **69**).

- **Symmetry**: 32 SEO + influencer skills `git mv`-ed into subfolders (history preserved), then `seo/` → `seo-geo/` and `paid/` → `ad/` for a clean discipline slug set. Two generic relink passes recomputed **679 relative links** total (0 broken); `plugin.json` + both `marketplace.json` mirrors repathed.
- **`paid/` → `ad/` — full alignment**: directory + command `/aaron-marketing:ad` (`commands/ad.md`) + `discipline: ad` slug (17 refs) + `memory/ad/` + `memory/audits/ad/`. The **"Paid Ads" display name and the ROAS framework are unchanged** — the technical identifier is `ad`, exactly as `seo-geo/` displays as "SEO/GEO".
...
- **Paid Ads discipline (8 skills + ROAS framework)** across the 4-phase ROAS loop — Research: campaign-architect, audience-segment-builder; Orchestrate: ad-creative-builder, ad-test-designer; Activate: ad-account-auditor (auditor-class gate → `memory/audits/ad/`), conversion-signal-qa; Scale: paid-measurement-loop, attribution-reconciler. `roas-benchmark.md` (R/O/A/S, RQS arithmetic rollup, vetoes R1/R2/O1/O2/A1). content-reviewer promoted to the C³ ART gate consumer (`memory/audits/influencer/`). Per the Balanced anti-bloat design, search-term mining and bid-pacing/learning-phase ship as **modes** of campaign-architect and budget-optimizer (not standalone skills); budget-optimizer/landing-optimizer/roi-calculator/report-generator/performance-analyzer are reused cross-discipline.
