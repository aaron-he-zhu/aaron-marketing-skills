...
- **`list`** — the skill list between SYNC markers is regenerated from `plugin.json`. Each item links directly to the skill's crawlable `blob/main/.../SKILL.md` page rather than its `tree/main/` directory.
