...
- [ ] Placed in the correct phase directory (SEO/GEO: research/build/optimize/monitor · protocol: protocol · influencer: discover/plan/activate/measure · paid: `paid/<phase>/` — research/orchestrate/activate/scale)
