"""Engineering-only v19 release-receipt issuer tests."""
...
class EngineeringReleaseReceiptIssuerTests(unittest.TestCase):
    ...
    def test_issue_runs_dynamic_audit_and_rechecks_source_after_write(self):
        ...
        with tempfile.TemporaryDirectory() as temporary, mock.patch.object(
            ...
            issuer, "committed_release_version", return_value="19.0.0"
        ), mock.patch.object(
            ...
            self.assertEqual("19.0.0-rc.7", receipt["release_candidate"])
