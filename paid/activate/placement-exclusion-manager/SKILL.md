...
- **Writes**: a user-facing exclusion plan, the A1 evidence file, and a reusable summary to `memory/paid-ads/placement-exclusion-manager/`.
...
On user confirmation, save to `memory/paid-ads/placement-exclusion-manager/YYYY-MM-DD-<account-or-goal>-exclusions.md` — see [Skill Contract](../../../references/skill-contract.md) §Save Results Template.
